...
export default {
  data() {
    return {
      ...
      messageFeature: [
        {
          title: "Save Essential Text Messages",
          description:
        ...
        {
          title: "Save Video, Audio, and PDFs",
          description:
      ...
      chatSyncFeature: [
        {
          title: "Sync Your WhatsApp Chats",
          description:
